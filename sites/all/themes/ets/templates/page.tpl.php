...
<head>
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <link rel="stylesheet" href="/sites/all/themes/ets/css/sections/<?php print $uri[1] ?>.css" type="text/css" media="all" />
  <script type="text/javascript"><?php /* Needed to avoid Flash of Unstyled Content in IE */ ?> </script>
  <script type="text/javascript" src="http://widgets.twimg.com/j/2/widget.js"></script>
  <script type="text/javascript" src="/misc/jquery.autoheight.js"></script>
</head>
  ...
  <div id="page">
	  ...
	  <!-- End Google custom search module !-->	
    	  	...
    	  	<?php if ($logo or $site_name or $site_slogan): ?>
          		<?php if ($logo): ?>
            		<div id="logo">
					<a href="<?php print $base_path; ?>" title="<?php print t('CCA Educational Technology Services'); ?>" rel="home"><img src="/sites/all/themes/ets/images/logo.march2.png" alt="CCA Educational Technology Services" /></a>
					</div>
          		<?php endif; ?>
      		<?php endif; ?>
